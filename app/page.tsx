    ...
    <div className={`min-h-screen ${isDarkMode ? "dark" : ""}`}>
      <div className="flex h-screen bg-background">
        ...
        <div className="w-64 bg-card border-r border-border p-4 flex flex-col">
          ...
          {/* Upload Button */}
          <Button className="mb-6 w-full" size="lg" onClick={() => setUploadModalOpen(true)}>
        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {filteredFiles.length > 0 && (
                  <Button variant="outline" size="sm" onClick={() => setBulkDownloadModalOpen(true)}>
          ...
          {/* File Drop Zone */}
          <div
            className={`flex-1 p-6 ${dragActive ? "bg-muted/50" : ""}`}
          ...
          >
            {dragActive && (
              <div className="fixed inset-0 bg-primary/10 border-2 border-dashed border-primary flex items-center justify-center z-50">
                <div className="text-center">
                  ...
                  <p className="text-lg font-medium">Drop any files here to upload</p>
                </div>
              </div>
            )}
            ...
            {filteredFiles.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <h3 className="text-lg font-medium mb-2">No dump files yet</h3>
                <p className="text-muted-foreground mb-4">
                  {searchQuery ? "No files match your search." : "Upload any files to get started."}
                </p>
                {!searchQuery && (
              ...
              >
                {filteredFiles.map((file) => (
                  <Card
                    key={file.id}
                    className={`${viewMode === "list" ? "p-4" : "p-3"} hover:shadow-md transition-shadow`}
                  >
                      ...
                      {viewMode === "list" ? (
                        <>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <Button variant="ghost" size="icon" onClick={() => handleFileDelete(file.id)}>
                        ...
                        <div className="text-center">
                          <div
                            className="w-12 h-12 mx-auto mb-3 flex items-center justify-center bg-muted rounded-lg cursor-pointer hover:bg-muted/80"
                            onClick={() => handleFilePreview(file)}
                          >
                            {getFileIcon(file.type)}
                          </div>
      ...
      <Dialog open={uploadModalOpen} onOpenChange={setUploadModalOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Upload Dump Files</DialogTitle>
          </DialogHeader>
